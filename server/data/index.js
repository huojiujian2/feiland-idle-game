...
const { DAILY_ACTIVE_TIERS, DAILY_ACTIVE_SOURCES } = require('./active');
const { GUILD_ROLES, GUILD_ROLE_ORDER, GUILD_PERMS, GUILD_LEVELS, GUILD_CREATE_COST, GUILD_NAME_RULE, DONATE_OPTIONS, MAX_GUILDS, GUILD_LOG_LIMIT, GUILD_ARCHIVE_LIMIT, VICE_LIMIT_PER_GUILD, OFFICER_LIMIT_PER_GUILD, getGuildLevel, getNextLevelExp, getGuildMaxMembers } = require('./guild');
...
module.exports = {
  ...
  DAILY_ACTIVE_TIERS, DAILY_ACTIVE_SOURCES,
  GUILD_ROLES, GUILD_ROLE_ORDER, GUILD_PERMS, GUILD_LEVELS, GUILD_CREATE_COST, GUILD_NAME_RULE, DONATE_OPTIONS, MAX_GUILDS, GUILD_LOG_LIMIT, GUILD_ARCHIVE_LIMIT, VICE_LIMIT_PER_GUILD, OFFICER_LIMIT_PER_GUILD, getGuildLevel, getNextLevelExp, getGuildMaxMembers,
};